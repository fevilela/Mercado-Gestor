      ...
      <div className="space-y-8">
        ...
        <Tabs defaultValue="config" className="space-y-4">
          ...
          <TabsContent value="config" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Configuração Fiscal da Empresa</CardTitle>
                <CardDescription>
                  Dados fiscais e certificados para integração com SEFAZ
                </CardDescription>
              </CardHeader>
                ...
                {loading ? (
                  ...
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          value={config.cnae || ""}
                          onChange={(e) =>
                            setConfig({ ...config, cnae: e.target.value })
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          value={config.im || ""}
                          onChange={(e) =>
                            setConfig({ ...config, im: e.target.value })
                          }
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            placeholder="Código de Segurança do Cliente"
                          />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="cscToken">CSC Token</Label>
                          <Input
                            id="cscToken"
                            data-testid="input-csc-token"
                            type="password"
                            value={config.nfceCscToken || ""}
                            onChange={(e) =>
                              setConfig({
                                ...config,
                                nfceCscToken: e.target.value,
                              })
                            }
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="cert">Certificado (.pfx)</Label>
                          <Input
                            id="cert"
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            type="password"
                            value={config.nfeCertificatePassword || ""}
                            onChange={(e) =>
                              setConfig({
                                ...config,
                                nfeCertificatePassword: e.target.value,
                              })
                            }
